import { EC2Client, DescribeRegionsCommand, DescribeInstancesCommand, DescribeVolumesCommand } from "@aws-sdk/client-ec2";
...
async function scanRegion(region, credentials){
    ...
    const instanceMetrics = instances.map((instanceId, index) => {
...
export const scanAccount = ErrorWrapper(async (req,res,next) => {
    ...
    try {
        ...
        try {
            ...
            throw new ErrorHandler(401,`Error in Saving Report`);
        }
        ...
        throw new ErrorHandler(401,`Error in Generating Report`);
    }
